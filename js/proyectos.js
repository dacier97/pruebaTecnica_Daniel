...
(form = document.querySelector("form")),
  ...
  (devp = document.getElementById("devp")),
  (ci = document.getElementById("ci")),
  (cd = document.getElementById("cd")),
  (front = document.getElementById("front")),
  (back = document.getElementById("back")),
  (datab = document.getElementById("datab")),
...
newMemberAddBtn.addEventListener("click", () => {
  ...
  modalTitle.innerHTML = "Completar Formulario ";
    ...
    for (var i = tab_start; i < tab_end; i++) {
      ...
      if (staff) {
        let createElement = `<tr class = "employeeDetails">
                ...
                <td>${staff.ciVal}</td>
                <td>${staff.cdVal}</td>
                <td>${staff.frontVal}</td>
                <td>${staff.backVal}</td>
                <td>${staff.databVal}</td>
                <td>
                    <button onclick="readInfo('${staff.picture}', '${
          staff.fName
        }', '${staff.lName}', '${staff.repVal}', '${staff.devpVal}', '${
          staff.ciVal
        }', '${staff.cdVal}', '${staff.frontVal}', '${staff.backVal}', '${
          staff.databVal
...
form.addEventListener("submit", (e) => {
  ...
  const information = {
    ...
    ciVal: ci.value,
    cdVal: cd.value,
    frontVal: front.value,
    backVal: back.value,
    databVal: datab.value,
  };
...
filterData.addEventListener("input", () => {
  ...
  if (searchTerm !== "") {
    const filteredData = originalData.filter((item) => {
      ...
      const city = item.devpVal.toLowerCase();
      const position = item.ciVal.toLowerCase();

      return (
        fullName.includes(searchTerm) ||
        devp.includes(searchTerm) ||
